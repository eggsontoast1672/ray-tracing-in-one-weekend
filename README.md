...
This repository holds my code for the *Ray Tracing in One Weekend* book. I
...
understand, but it is also very easy to parse. This is the image format that the
renderer will output.
...
The next two numbers in the file are the dimensions of the image, in pixels. The
first number represents the width and the second represents the height, and they
should be separated by a space. The next number after the dimensions is the
number of bits per component. For example, if you only wanted pure red, green or
blue, you could set this number to 1.
...
component respectively. A complete example taken from the [Netpbm Wikipedia][1]
page follows:
